...
INSERT_COMMAND = "insert into ROOM(url, price, area, isRemoved,                         special_label, rooms, halls, toilet, rent_way,                         location, is_near_subway, direction, floor, publish_time, title)                         values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"
